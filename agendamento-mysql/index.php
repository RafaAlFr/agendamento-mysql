...
<body> 
	<div class="container">
		<div class="row">
			<nav class="navbar navbar-expand-lg navbar-light bg-pink col-12" style="background-color: #a3a3a3	;">
				...
				<div class="card-body">
					...
					<p>
						<form method="post" action="controller/ControllerCadastro.php?funcao=cadastro" id="form" name="form">
							...
							<button type="submit" id="btnInserir" class="btn btn-outline-dark">Cadastrar</button>
						</form>
					</p>
				</div>
			</div>
